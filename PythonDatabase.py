...
import pandas as pd
#Delete databse: DROP DATABASE school;
#Show database: SHOW DATABASES;
#Select database: USE school;
...
#take our SQL queries, stored in Python as strings, and pass them to the cursor.execute() method to execute them on the server. 
